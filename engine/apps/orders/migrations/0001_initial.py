    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_session_id', models.CharField(db_index=True, help_text='Deterministic storefront session identity scoped to store.', max_length=255)),
                ...
                ('courier_tracking_code', models.CharField(blank=True, default='', max_length=100)),
                ('courier_status', models.CharField(blank=True, default='', max_length=50)),
